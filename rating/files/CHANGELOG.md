...
- bugfix: Knockout doesn't recognize values set by the widget unless we call change() on the select tag. (@aRsaykarle, [#25](https://github.com/antennaio/jquery-bar-rating/pull/25))
